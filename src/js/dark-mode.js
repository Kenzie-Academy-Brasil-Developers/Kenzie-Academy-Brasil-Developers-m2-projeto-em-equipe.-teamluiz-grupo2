function darkMode(){
  ...
  !mode ? buttonChange.innerText=iconeLight : (body.classList.add(thema), buttonChange.innerText=iconeDark)
  buttonChange.addEventListener('click',()=>{
    !mode ? (mode=!mode, buttonChange.innerText=iconeDark) : (mode=false,buttonChange.innerText=iconeLight)
